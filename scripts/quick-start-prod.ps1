# Script de inicializacao rapida - API em modo PRODUCAO (Railway)
Write-Host ""
Write-Host "ITEM CONTROL SYSTEM - INICIALIZACAO RAPIDA (PRODUCAO)" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "   Modo: PRODUCAO | MongoDB: Railway | Porta: 8080" -ForegroundColor White
